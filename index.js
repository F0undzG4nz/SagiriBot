const  FzBOT = 'SAGIRI CHAN ID'; // Nama Bot Whatsapp
const instagram = 'https://instagram.com/aditiapurna_'; // Nama Instagramlu cok
const nomer = 'https://Wa.me/+6289664550953'; // Nomor whatsapplu cok
const aktif = 'Tergantung kuota'; // Kapan bot lu aktif
const groupwa = 'comming soon'; // OFFICIAL GRUP LU 1
const youtube = 'https://www.youtube.com/channel/UCHL57OEnX9BwTheOpzh2LYQ'; 
...
const vcard = 'BEGIN:VCARD\n' // metadata of the contact card
            ...
            + 'TEL;type=CELL;type=VOICE;waid=6289664550953:+62 859-1101-12843\n' // WhatsApp ID + phone number
            + 'END:VCARD'
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] FzBOT Ready scan now!`);
});
...
conn.sendMessage(id, 'Owner FzBOT wa.me/+6289664550953' ,MessageType.text);
}
else if (text == 'affis'){
conn.sendMessage(id, 'Aku BOT nya FzBOT' ,MessageType.text);
}
else if (text == 'audio'){
...
conn.sendMessage(id, menu.menu(id,  FzBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
if (text == '#donasi'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  FzBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, donate.donate(id,  FzBOT, corohelp, tampilTanggal, tampilWaktu, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#DONATE'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, info.info(id,  FzBOT, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwa, youtube) ,MessageType.text);
}
else if (text == '#foto'){
conn.sendMessage(id, 'kirim .foto cewek/cowok\n\nContoh: .foto cewek' ,MessageType.text);
}
else if (text == '#menu'){
conn.sendMessage(id, ' 🔍Thanks Telah Menggunakan BOT *FzBOT* , Follow Instagram Mimin Yah🔍� : https://instagram.com/@aditiapurna_' ,MessageType.text);
}
else if (text == '#info'){
conn.sendMessage(id, ' 🔍Thanks Telah Menggunakan BOT *FzBOT* , Follow Instagram Mimin Yah🔍� : https://instagram.com/@aditiapurna_' ,MessageType.text);
}
